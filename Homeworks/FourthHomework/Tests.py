...
class PotionTest(unittest.TestCase):
    ...
    def test_combined_potion_has_all_effects(self):
        ...
        self.assertTrue('grow' in dir(all_potion))
        self.assertTrue('heal' in dir(all_potion))
        self.assertTrue('invisible' in dir(all_potion))
        self.assertTrue('fly' in dir(all_potion))
    ...
    def test_diluted_potion_with_zero_intensity(self):
        ...
        self.assertTrue('fly' in dir(fly_potion))
